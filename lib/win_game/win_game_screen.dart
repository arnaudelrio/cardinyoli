...
class WinGameScreen extends StatefulWidget {
  ...
  final String winnerName1;
  final String winnerName2;

  const WinGameScreen({
    super.key,
    required this.score,
    required this.cumulatedScore,
    required this.winnerName1,
    required this.winnerName2,
  });
...
class _WinGameScreenState extends State<WinGameScreen>
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            '${widget.winnerName1}  &  ${widget.winnerName2}',
            textAlign: TextAlign.center,
            style: TextStyle(
              fontFamily: 'Permanent Marker',
              fontSize: 22,
          ...
          Row(
            ...
            children: [
              _buildTotalScore(palette, widget.cumulatedScore.team1Score),
              Padding(
              ...
              _buildTotalScore(palette, widget.cumulatedScore.team2Score),
            ],
          ),
        ],
      ),
  ...
  Widget _buildTotalScore(Palette palette, int score) {
    return Text(
      '$score',
      style: TextStyle(
        fontFamily: 'Permanent Marker',
