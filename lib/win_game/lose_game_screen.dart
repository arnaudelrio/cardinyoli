...
class LoseGameScreen extends StatefulWidget {
  final int score;
  ...
  @override
  State<LoseGameScreen> createState() => _LoseGameScreenState();
}

class _LoseGameScreenState extends State<LoseGameScreen>
