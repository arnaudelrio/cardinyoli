...
class LocalStorageSettingsPersistence extends SettingsPersistence {
  ...
  @override
  Future<bool> getDeckType({required bool defaultValue}) async {
    final prefs = await instanceFuture;
    return prefs.getBool('deckType') ?? defaultValue;
  }
  ...
  @override
  Future<void> saveDeckType(bool value) async {
    final prefs = await instanceFuture;
    await prefs.setBool('deckType', value);
  }
}
