...
class SettingsController {
  ...
  /// Which deck of cards is to be used
  ValueNotifier<bool> usePokerCards = ValueNotifier(false);
  ...
  void togglePokerCards() {
    usePokerCards.value = !usePokerCards.value;
    _store.saveDeckType(usePokerCards.value);
  }
  
  get pokerCards => usePokerCards.value;
  ...
  Future<void> _loadStateFromPersistence() async {
    final loadedValues = await Future.wait([
      ...
      _store.getDeckType(defaultValue: false).then((value) => usePokerCards.value = value),
